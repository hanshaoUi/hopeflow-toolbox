...
export const pathScripts: ScriptMetadata[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'marginTop',    type: 'number', label: '上距边 (mm)', default: 0, step: 0.5 },
      { name: 'marginRight',  type: 'number', label: '右距边 (mm)', default: 0, step: 0.5 },
      { name: 'marginBottom', type: 'number', label: '下距边 (mm)', default: 0, step: 0.5 },
      { name: 'marginLeft',   type: 'number', label: '左距边 (mm)', default: 0, step: 0.5 },
      {
        name: 'countMode',
        type: 'select',
        label: '分布方式',
