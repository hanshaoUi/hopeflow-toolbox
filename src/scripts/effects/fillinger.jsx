/* 
  ...
  作者: A Jongware Script (Circle fill)
  程序版本: Adobe Illustrator CC+
  名称: fillinger.jsx;

  修改和重构: Alexander Ladygin
  www.ladyginpro.ru
...
if (app.documents.length && app.selection.length < 2) {
    ...
    var win = new Window('dialog', '随机填充');
    ...
    var sizePanel = globalGroup.add('panel', undefined, '项目大小(占总大小的百分比)'),
    ...
    var maxValueLabel = maxValueGroup.add('statictext', undefined, '最大:'),
    ...
    var minValueLabel = minValueGroup.add('statictext', undefined, '最小:'),
    ...
    var guttersLabel = guttersGroup.add('statictext', undefined, '最小距离')
    ...
    var resizeLabel = resizeGroup.add('statictext', undefined, '缩放值')
    ...
    var rotatePanel = rotatePositionGroup.add('panel', undefined, '旋转项目:');
    ...
    var randomRotate = randomRadioGroup.add('radiobutton', undefined, '随机'),
        rotateByValue = randomRadioGroup.add('radiobutton', undefined, '按值'),
    ...
    var objectPositionPanel = rotatePositionGroup.add('panel', undefined, '要填充的项目是:'),
    ...
    var objectPosTop = objectPositionGroup.add('radiobutton', undefined, '在顶部'),
        objectPosBottom = objectPositionGroup.add('radiobutton', undefined, '在底部'),
        objectPosLayers = objectPositionGroup.add('checkbox', undefined, '按[图层]顺序');
    objectPosTop.value = true;
    var groupResult = globalGroup.add('checkbox', undefined, '执行后编组'),
        randomItems = globalGroup.add('checkbox', undefined, '随机项目'),
        removeTopElement = globalGroup.add('checkbox', undefined, '执行后移除填充项目');
    ...
    */
    ...
    if ($.hopeflow) {
        ...
        // Map params
        maxValue.text = args.maxValue || 10;
        minValue.text = args.minValue || 4;
        guttersValue.text = args.guttersValue || 0;
        resizeValue.text = args.resizeValue || 70;
        randomRotate.value = args.randomRotate !== false; // Default true
        groupResult.value = args.groupResult === true;
