...
var __fillStrokeColorPanel = group1.add('panel', undefined, '填充或描边颜色:'),
    __fillStrokeColorAll = __fillStrokeColorPanel.add('checkbox', [0, 0, __attr.width, __attr.height / 1.5], '应用于所有项目'),
...
var __fillStrokeSwatchesPanel = group1.add('panel', undefined, '填充或描边色板:'),
__fillStrokeSwatchesAll = __fillStrokeSwatchesPanel.add('checkbox', [0, 0, __attr.width, __attr.height / 1.5], '应用于所有项目'),
__FillSwatches = __fillStrokeSwatchesPanel.add('button', [0, 0, __attr.width, __attr.height], '填充色板'),
__StrokeSwatches = __fillStrokeSwatchesPanel.add('button', [0, 0, __attr.width, __attr.height], '描边色板');
...
var __ScaleMin = __ScaleMinMaxGroup.add('edittext', [0, 0, __attr.width / 2.03, __attr.height], '50'),
  ...
  __ScaleOriginal = __ScaleGroup.add('checkbox', [0, 0, __attr.width / 1.2, __attr.height], '使用原始'),
...
var __RotateMin = __RotateMinMaxGroup.add('edittext', [0, 0, __attr.width / 2.03, __attr.height], '0'),
  ...
  __RotateOriginal = __RotateGroup.add('checkbox', [0, 0, __attr.width / 1.2, __attr.height], '使用原始'),
...
var __OpacityGroup = group3.add('panel', undefined, '不透明度:'),
...
var __OpacityMin = __OpacityMinMaxGroup.add('edittext', [0, 0, __attr.width / 2.03, __attr.height], '0'),
  ...
  __OpacityOriginal = __OpacityGroup.add('checkbox', [0, 0, __attr.width / 1.2, __attr.height], '使用原始'),
  __Opacity = __OpacityGroup.add('button', [0, 0, __attr.width, __attr.height], '不透明度');
...
var __PositionEach = __PositionGroup.add('checkbox', [0, 0, __attr.width / 1.2, __attr.height / 1.5], '每个项目'),
  __PositionOriginal = __PositionGroup.add('checkbox', [0, 0, __attr.width / 1.2, __attr.height], '使用原始'),
...
fixCompoundButton.helpTip = '规范化复合路径项目,移除组 - 仅路径项目';
...
var reset = winButtons.add('button', [0, 0, 75, 30], '重置');
...
var ok = winButtons2.add('button', buttonSize, '确定');
