                ...
                return (
                    <button
                        ...
                        style={{
                            ...
                            minWidth: 'unset',
                            height: 'auto',
                            background: isActive ? 'var(--color-accent-soft)' : isSelected ? 'var(--color-bg-control)' : 'var(--color-bg-tertiary)',
                            border: isActive ? '1px solid var(--color-accent)' : isSelected ? '1px solid var(--color-accent)' : '1px solid var(--color-border)',
                            color: isActive || isSelected ? 'var(--color-text-primary)' : 'var(--color-text-secondary)',
